export const ConfigFields = [
	...
	},
	{
		...
		id: 'accessKeyId',
		label: 'Access Key ID',
		tooltip: "Enter the Access Key ID you've created for the Companion user in the IAM.",
		width: 12,
	},
	{
		type: 'textinput',
		...
		tooltip: "Enter the Secret Access Key you've created for the Companion user in the IAM.",
		width: 12,
	},
	{
		type: 'dropdown',
	...
	},
	{
		...
		tooltip: 'Configure how often (in seconds) the EC2 states should get fetched from AWS (5 seconds to 1 hour)',
		default: 10,
		min: 5,
		max: 3600,
		width: 4,
